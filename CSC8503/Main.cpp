...
void TestNetworking() {
	...
	TestPacketReceiver clientReceiver("Clien");
...
int main() {
	...
	//TestPushdownAutomata(w);//Tutorial AI pushdown automata
	TestNetworking();//Tutorial networking protocols
	...
	//TestPathfinding();//Tutorial AI pathfinding
	//TestBehaviourTree();//Tutorial AI behaviour trees
	while (w->UpdateWindow() && !Window::GetKeyboard()->KeyDown(KeyCodes::ESCAPE)) {
		...
		//DisplayPathfinding();//Tutorial AI pathfinding
	}
